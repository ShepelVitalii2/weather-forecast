...
const ipCountry = fetch(`https://ipinfo.io/json?token=${IP_TOKEN}`)
  .then(response => response.json())
  .then(jsonResponse => console.log(jsonResponse.ip));

// текущая сводка погоды текущего пользователя
const currentIpWeather = fetch(
